<div ng-controller="EditSupplierCtrl" class="{{animated_class}}">
	<div class="head">
		<div class="top"> 
			<h2>{{title}}</h2>
	...
	<div class="body"> 
		...
		<form class="form-horizontal" name="editSupplierForm" id="editSupplierForm" > 
		    ...
		    <div class="row">
				<div class="col-md-6">
		 			<div class="form-group">
					    ...
					    <div class="col-sm-12"  ng-class="{ 'has-error' : !editSupplierForm.sup_id.$pristine && editSupplierForm.sup_id.$touched && editSupplierForm.sup_id.$invalid }">
			  	...
			  	<div class="col-md-6">
				  	<div class="form-group" ng-class="{ 'has-error' : !editSupplierForm.sup_name.$pristine && editSupplierForm.sup_name.$touched && editSupplierForm.sup_name.$invalid }">
		    ...
		    <div class="form-group">
				<div class="col-md-12" ng-hide="editSupplierForm.$invalid">
					<md-button class="btn btn_add submit" type="submit" ng-click="editSupplier()">Edit Supplier</md-button>
